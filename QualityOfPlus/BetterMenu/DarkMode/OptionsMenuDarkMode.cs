...
using QualityOfPlus.BetterMenu.DarkMode.Patches;
using System;
...
{
    internal class OptionsMenuDarkMode
    {
        ...
        public static void ApplyDarkMode(OptionsMenu menu, CustomOptionsHandler handler)
        {
            ...
            b.Find("BG").GetComponent<Image>().sprite = feature.OptionsDarkMode;
            ...
            foreach (Transform child in menu.transform)
                MainMenusDarkMode.ChangeMenuToggleColor(child, feature.WhiteCheckBox);
