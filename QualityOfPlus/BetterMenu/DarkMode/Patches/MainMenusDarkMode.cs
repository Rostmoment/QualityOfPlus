...
namespace QualityOfPlus.BetterMenu.DarkMode.Patches
{
    ...
    internal class MainMenusDarkMode
    {
        ...
        private static void ApplyDarkMode(MainMenu __instance)
        {
            ...
            button.unhighlightedSprite = feature.ExitNotHighlitghedDarkMode;
            button.highlightedSprite = feature.ExitHighlitghedDarkMode;
            button.Highlight();
            button.UnHighilight();
            ...
            __instance.StartCoroutine(General(__instance, feature));
        }

        private static IEnumerator General(MainMenu __instance, DarkModeFeature feature)
        {
            Coroutine[] coroutines = new Coroutine[]
            {
                __instance.StartCoroutine(ChangePickMenu(feature)),
                __instance.StartCoroutine(ChangeMenu("About", feature)),
                __instance.StartCoroutine(ChangeMenu("PickChallenge", feature)),
                __instance.StartCoroutine(ChangeMenu("PickFieldTrip", feature)),
                __instance.StartCoroutine(ChangeMenu("PickEndlessMap", feature)),
                __instance.StartCoroutine(ChangeMenu("HideSeekWarning", feature)),
                __instance.StartCoroutine(ChangeEndlessMenu(feature)),
                __instance.StartCoroutine(ChangeHideAndSeek(feature))
            };
        ...
        private static IEnumerator ChangeHideAndSeek(DarkModeFeature feature)
        {
            ...
            foreach (Transform t in target.transform)
                ChangeMenuToggleColor(t, feature.WhiteCheckBox);
        }
        private static IEnumerator ChangeMenu(string menu, DarkModeFeature feature)
        {
        ...
        private static IEnumerator ChangePickMenu(DarkModeFeature feature)
        {
        ...
        private static IEnumerator ChangeEndlessMenu(DarkModeFeature feature)
        {
        ...
        public static void ChangeMenuToggleColor(Transform transform, Sprite whiteSprite)
        {
            ...
            foreach (Transform child in transform)
                ChangeMenuToggleColor(child, whiteSprite);
        }
    }
}
